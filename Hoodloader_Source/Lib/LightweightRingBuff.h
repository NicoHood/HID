...
#define BUFF_RELEASE_RAM 16
#elif (HOODLOADER_PID == HOODLOADER_LITE)
#define BUFF_RELEASE_RAM 48
#else
#define BUFF_RELEASE_RAM 0
#endif

/** Size of each ring buffer, in data elements - must be between 1 and 255. */
#define BUFFER_SIZE         (128-BUFF_RELEASE_RAM) //reduced, needed some ram

/** Maximum number of data elements to buffer before forcing a flush.
 *  Must be less than BUFFER_SIZE
 */
#define BUFFER_NEARLY_FULL	(96-BUFF_RELEASE_RAM)
